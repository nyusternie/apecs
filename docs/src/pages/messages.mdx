...
Messages are what conversations are made of in Cash DevOps — they are the basic building blocks of your conversations with your Cash DevOps contacts. On this page, we'll dive into the different message endpoints you can use to manage messages programmatically. We'll look at how to query, send, update, and delete messages. {{ className: 'lead' }}
