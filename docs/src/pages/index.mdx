...
export const description =
  'Learn everything there is to know about the Cash DevOps and integrating our tools & resources into your project(s).'
...
Use the Cash DevOps API to access contacts, conversations, group messages, and more and seamlessly integrate your product into the workflows of dozens of devoted Cash DevOps users. {{ className: 'lead' }}
