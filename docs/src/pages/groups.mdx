...
Groups are where communities live in Cash DevOps — they are a collection of contacts you're talking to all at once. On this page, we'll dive into the different group endpoints you can use to manage groups programmatically. We'll look at how to query, create, update, and delete groups. {{ className: 'lead' }}
...
<Row>
  <Col>
    ...
    This endpoint allows you to create a new group conversation between you and a group of your Cash DevOps contacts.
