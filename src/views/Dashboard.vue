<template>
    <main class="bg-blue-400 w-screen">
        <Header pageId="dashboard" />

        <div class="sm:hidden m-5 text-gray-700 text-sm border-2 border-pink-500 bg-pink-100 rounded-3xl p-3">
            ...
            <p class="mt-2">
                Please explore this <span class="font-bold">Mobile</span> version to discover our benefits and learn more about our mission.
            </p>
        </div>
