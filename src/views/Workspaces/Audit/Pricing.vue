                ...
                <table class="w-full h-px table-fixed">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="w-1/4 pb-4 px-6 text-lg leading-6 font-medium text-gray-900 text-left" scope="col">COMMUNITY</th>

                            <th class="w-1/4 pb-4 px-6 text-lg leading-6 font-medium text-gray-900 text-left" scope="col">STARTUP</th>
                                ...
                                <div class="h-full flex flex-col justify-between">
                                    <div>
                                        <p>
                                            ...
                                            <span class="text-2xl font-extrabold text-gray-900"> + $99</span>
                                    ...
                                    <a href="javascript://" class="mt-6 block w-full bg-gradient-to-r from-orange-500 to-pink-500 border border-transparent rounded-md shadow py-2 text-sm font-semibold text-white text-center hover:to-pink-600">
                                        Buy Essential
                                    </a>
                                </div>
                            </td>
